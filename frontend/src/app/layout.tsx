      ...
      <body className="bg-slate-50 text-slate-900 font-sans min-h-screen selection:bg-indigo-500/30 flex">
        ...
        <aside className="w-64 shrink-0 bg-[#0B1B3D] text-slate-300 flex flex-col h-screen sticky top-0 border-r border-slate-700 shadow-xl overflow-y-auto">
          ...
          <nav className="flex-1 px-4 py-8 space-y-2">
            ...
            <a href="/graph" className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-slate-400 hover:bg-[#152a55] hover:text-white group">
              <svg className="w-5 h-5 group-hover:text-indigo-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
